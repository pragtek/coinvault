                    ...
                    <DropdownMenuContent align="end" className="w-72">
                      ...
                      <div className="px-2 py-2">
                        ...
                        <div className="bg-lightblue-50 p-2 rounded-md text-sm font-mono mb-3">
                          {account ? `${account.substring(0, 6)}...${account.substring(account.length - 4)}` : ""}
                          <hr/>
                          ETH : {`${(ethBalance == null) ? 'n/a' : Number.parseFloat(ethBalance).toFixed(4)}`} ETH<br/>
                          dETH : {`${(dETHBalance == null) ? 'n/a' : Number.parseFloat(dETHBalance).toFixed(4)}`} dETH<br/>
                          sETH : {`${(sETHBalance == null) ? 'n/a' : Number.parseFloat(sETHBalance).toFixed(4)}`} sETH<br/>
                        </div>
